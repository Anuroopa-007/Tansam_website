...
export class HeroComponent implements OnInit {
  ...
  images: SliderItem[] = [
    ...
    },
    {
      ...
      published: true,
      alt: 'Slide 2',
      title: 'Siemens and TANSAM Officials with Honorable Chief Minister of Tamil Nadu Thiru.M.K.Stalin at TANSAMs Inauguration',
      caption: '',
    },
    {
      ...
      published: true,
      alt: 'Slide 3',
      title: 'TIDCO and SIEMENS Officials welcoming the guest',
      caption: '',
    },
    {
      ...
      published: true,
      alt: 'Slide 4',
      title: 'DPH Signing MOU with TANSAM',
      caption: '',
    },
    {
